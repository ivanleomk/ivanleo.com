...
Here is the [code](https://github.com/ivanleomk/next-auth-sample-next-13) and a [working deployment](https://next-auth-sample-next-13.vercel.app/) that you can play around with
</Callout>
...
I think this tweet from [Dax](https://twitter.com/thdxr) sums up my experience with auth libraries pretty well.
