...
- [BERT](https://llm-paper-club-asia-notes.vercel.app/papers/bert)
- [T5](https://llm-paper-club-asia-notes.vercel.app/papers/text-to-text)
- Self-Rewarding Language Models

I also published a new article on [writing better python code](/blog/write_code_to_refactor) on some of the key changes in the way I write python code after working in python for the last 5 months. 
...
I've been delving deeper into open source models and experimenting with Cohere's re-ranker. That's how I learnt about batch processing data when Nils Reimer started correcting my usage on [twitter](https://twitter.com/ivanleomk/status/1745413367282663791) and discovered that you should not be using a re-ranker model to evaluate textual similarity. Ended up also learning about these new cool metrics such as AUC and Precision to evaluate my results which has been interesting.

I also started a [paper club](https://lu.ma/llm-paper-asia) under Latent Space to help increase interest in LLMs starting with the Attention Is All You Need paper. 

## 2023

### December

In December I slowed down the stuff I was doing and took a slight holiday. I ended up experimenting more with Text to UI platforms and documented how I was able to put together a small front-end demo using MagicPatterns in a short [tweet](https://twitter.com/ivanleomk/status/1743321223155556686/photo/1) breaking down the specific steps that I took and what the intermediate products were.
...
- [Good LLM Validation is Just Good Validation](https://jxnl.github.io/instructor/blog/#good-llm-validation-is-just-good-validation)
...
- [Using GPT4 To generate React Components using the @shadcn/ui library](blog/gpt_react)
- Creating an Arxiv Crawler

I also finally got around to finishing up a [quick article](blog/deriving_the_derivative_for_a_softmax_cross_entropy) on the derivation of the softmax and cross entropy loss which I worked through in CS321n. I struggled with it for quite some time and thought it might help others.
