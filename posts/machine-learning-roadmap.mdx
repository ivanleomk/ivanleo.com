...
I also finally got around to finishing up a [quick article](blog/deriving_the_derivative_for_a_softmax_cross_entropy) on the derivation of the softmax and cross entropy loss which I worked through in CS321n.
